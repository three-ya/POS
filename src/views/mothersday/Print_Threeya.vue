        ...
        <div class="subpage row g-0 h-100">
          <div v-for="(order, orderIndex) in page" :key="'order-' + orderIndex" class="col-4 card-group">
            <div class="order card">
              ...
              <div class="card-body">
                <div>
                  <div v-if="order['$3000'] > 0" class="text-center fs-4">$3000<span>×{{ order['$3000'] }}</span></div>
                  <div v-if="order['$4000'] > 0" class="text-center fs-4">$4000<span>×{{ order['$4000'] }}</span></div>
                  <div v-if="order['$5000'] > 0" class="text-center fs-4">$5000<span>×{{ order['$5000'] }}</span></div>
                </div>
                <div>
                  <template
                    v-if="
